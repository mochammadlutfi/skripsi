                ...
                <div class="row px-0">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama" id="field-nama" placeholder="Masukan Nama Pelanggan" value="{{ $data->nama }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="field-alamat" name="alamat" placeholder="Masukan Alamat Lengkap" rows="2">{{ $data->alamat }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lat" id="field-lat" value="{{ $data->lat }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lng" id="field-lng" value="{{ $data->lng }}">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="perwakilan_kontak" id="field-perwakilan_kontak" placeholder="Masukan No. Kontak Perwakilan" value="{{ $data->perwakilan_kontak }}">
