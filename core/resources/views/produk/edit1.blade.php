...
<div class="content">
    <form id="form-produk" onsubmit="return false;">
        <input type="hidden" name="total_variasi" id="total_variasi" value="{{ $produk->variasi }}">
        ...
        <div class="block block-rounded">
            <div class="block-content pb-15">
                <input type="hidden" name="has_variasi" id="has_variasi" value="{{ $produk->produk_variasi()->count() }}">
                ...
                <div class="row border-bottom mx-0 mb-2 tanpa_variasi">
                ...
                <div class="row px-0 tanpa_variasi">
                    <input type="hidden" id="field-variasi_id" name="variasi_id" value="{{ $variasi->id }}">
                    <div class="col-lg-4">
                        <div class="form-group mb-0">
                            <label for="field-sku">Kode Produk (SKU)</label>
                            <input type="text" class="form-control" id="field-sku" name="sku" placeholder="Masukan Kode Produk (SKU)" value="{{ $variasi->sku }}">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" class="form-control" id="field-hrg_modal" name="hrg_modal" placeholder="Masukan Harga Modal" value="{{ round($variasi->hrg_modal, 0) }}">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" class="form-control" id="field-hrg_jual" name="hrg_jual" placeholder="Masukan Harga Jual" value="{{ round($variasi->hrg_jual, 0) }}">
                    ...
                    <div class="col-lg-12 px-0">
                        <div class="form-group">
                            <div class="custom-control custom-checkbox checkbox-lg mb-5">
                                <input class="custom-control-input" type="checkbox" name="kelola_stok" id="kelola_stok" value="1" @if($variasi->kelola_stok == '1')checked=""@endif data-kelola_stok="{{ $variasi->kelola_stok }}">
                                <label class="custom-control-label" for="kelola_stok">Kelola Inventaris</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row px-0 tanpa_variasi inventaris">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="field-unit">Satuan Unit</label>
                            <select class="form-control" id="field-unit" name="unit" placeholder="Pilih Satuan Unit" style="width:100%;" @if($variasi->kelola_stok === 1) data-id="{{ $variasi->satuan_id }}" data-text="{{ $variasi->satuan->nama }}" @endif>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="field-min_stok" name="min_stok" placeholder="Masukan Minimum Stok" value="{{ $variasi->min_stok }}">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" step=".01" id="field-volume" name="volume" placeholder="Masukan Volume Produk" value="{{ $variasi->volume }}">
