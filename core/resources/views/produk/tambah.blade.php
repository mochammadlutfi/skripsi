...
<div class="content">
    <form id="form-produk" onsubmit="return false;">
        ...
        <input type="hidden" name="submit_tipe" id="submit_tipe" value="">
        ...
        <div class="block block-rounded">
            <div class="block-content pb-15">
                <div class="row info_produk">
                    <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="field-nama" name="nama" placeholder="Masukan Nama Produk">
                            <div id="error-nama" class="invalid-feedback"></div>
                        </div>
                        <div class="form-group">
                            <label for="field-kategori">Kategori</label>
                            <select class="form-control" id="field-kategori" name="kategori" placeholder="Pilih Kategori">
                            </select>
                            <div id="error-kategori" class="invalid-feedback"></div>
                        </div>
                        <div class="form-group">
                            <label for="field-merk">Merk</label>
                            <select class="form-control" id="field-merk" name="merk" placeholder="Pilih Merk"></select>
                ...
                <div class="row px-0 tanpa_variasi inventaris">
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label for="field-kategori">Satuan Unit</label>
...
<script src="{{ asset('assets/js/pages/produk-form.js') }}"></script>
@endpush
