        ...
        <div class="col-lg-4">
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title" id="form-title">Tambah Kategori Produk</h3>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-popout" role="document">
        <div class="modal-content">
            <div class="block mb-0">
                <div class="block-header block-header-default">
                        <h3 class="block-title modal-title">Perbaharui Kategori</h3>
                ...
                <div class="block-content">
                    <form id="form-update_kategori" onsubmit="return false;">
                        <input type="hidden" name="kategori_id" value="">
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label" >Nama Kategori</label>
                            <div class="col-lg-8">
                                <input type="text" id="field-upt_nama" class="form-control" name="upt_nama" placeholder="Masukan Nama Kategori">
...
@stop
@push('scripts')
<script src="{{ asset('assets/js/pages/kategori.js') }}"></script>
@endpush
