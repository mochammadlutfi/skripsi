            ...
            <div class="block block-rounded block-transparent bg-gd-dusk">
                <div class="block-content block-content-full block-sticky-options">
                    ...
                    <div class="py-20 text-center">
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-white-op">Total Pengadaan</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="block block-rounded block-transparent bg-gd-elegance">
                <div class="block-content block-content-full block-sticky-options">
                    ...
                    <div class="py-20 text-center">
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-white-op">Nominal Pengadaan</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="block">
        ...
        <div class="block-content pb-15">
            ...
            <table class="table table-hover table-vcenter" id="list-riwayat">
                ...
                @include('pembelian.include.draft_data')
            </table>
...
<script src="{{ asset('assets/js/pages/mitra/pembelian-draft.js') }}"></script>
@endpush
