                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label" for="field-supplier">Supplier</label>
                            <div class="col-lg-8">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label" for="field-tgl_transaksi">Tanggal</label>
                            <div class="col-lg-8">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table class="table table-vcenter" id="pembelian_table">
                            ...
                            <tbody>
                                {{-- @include('pembelian.include.entry_row') --}}
                            </tbody>
                            <tfoot>
...
<script src="{{ asset('assets/js/pages/mitra/pembelian-form.js') }}"></script>
<script>
</script>
@endpush
