...
<div class="content">
    <form id="form-penjualan" method="post" onsubmit="return false;">
        <input type="hidden" id="tipe_transaksi" value="penjualan">
        @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="field-sales" name="sales" style="width: 100%;"></select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="field-tgl_transaksi" name="tgl_transaksi" placeholder="Tanggal Transaksi" value="{{ $tgl_transaksi }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="field-tgl_pengiriman" name="tgl_pengiriman" placeholder="Tanggal Pengiriman" value="{{ $tgl_kirim }}">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <div class="col-lg-12">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="show_rp" style="display: none">
                                            Rp
                                        </span>
                                    </div>
                                    <input type="number" class="form-control" id="field-diskon" name="diskon" value="0" disabled>
                                    <div class="input-group-append" id="show_persen" style="display: none">
...
<script src="{{ asset('assets/js/pages/penjualan-form.js') }}"></script>
