            ...
            <div class="row">
                <div class="col-4">
                    <div class="form-group">
                        <label for="tgl_range">Tanggal Transaksi</label>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="field-keyword" class="form-control" placeholder="Masukan Kata Kunci">
                        </div>
                    </div>
                </div>
                <div class="col-4">
...
<script src="{{ asset('assets/js/pages/penjualan.js') }}"></script>
@endpush
