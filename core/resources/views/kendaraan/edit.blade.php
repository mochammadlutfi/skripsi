                ...
                <div class="row px-0">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="jenis" id="field-jenis">
                                ...
                                <option value="motor" @if($data->jenis == 'motor') selected="selected"  @endif>Motor</option>
                                <option value="mobil" @if($data->jenis == 'mobil') selected="selected"  @endif>Mobil</option>
                            </select>
                            <div id="error-jenis" class="invalid-feedback"></div>
                        </div>
                        <div class="form-group">
                            <label for="field-tipe">Tipe</label>
                            <input type="text" class="form-control" id="field-tipe" name="tipe" placeholder="Masukan Tipe Kendaraan" value="{{ $data->tipe }}">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_polisi" id="field-no_polisi" placeholder="Masukan No. Polisi" value="{{ $data->no_polisi }}">
                            <div id="error-no_polisi" class="invalid-feedback"></div>
                        </div>
                        <div class="form-group">
                            <label for="field-max_kapasitas">Kapasitas Maksimal</label>
                            <input type="text" class="form-control" name="max_kapasitas" id="field-max_kapasitas" placeholder="Masukan Kapasitas Maksimal" value="{{ $data->max_kapasitas }}">
...
$(document).ready(function () {
    $("#form-kendaraan").submit(function (e) {
        ...
        $.ajax({
            url: laroute.route('kendaraan.update'),
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
            ...
            success: function (response) {
                ...
                if (response.fail == false) {
                    Swal.fire({
                        title: "Berhasil",
                        text: "Data Kendaraan Berhasil Diperbaharui!",
                        timer: 3000,
                        showConfirmButton: false,
                        icon: 'success'
                    });
