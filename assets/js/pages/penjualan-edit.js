jQuery(document).ready(function () {
    ...
    get_cart();
    pelangganSelect = $("#field-pelanggan").select2({
    ...
    pelangganOption = new Option($('#field-pelanggan').attr("data-text"), $('#field-pelanggan').attr("data-id"), true, true);
    pelangganSelect.append(pelangganOption).trigger('change');

    salesSelect = $("#field-sales").select2({
    ...
    salesOption = new Option($('#field-sales').attr("data-text"), $('#field-sales').attr("data-id"), true, true);
    salesSelect.append(salesOption).trigger('change');
    ...
    $(document).on('input', '#field-jml_bayar', function() {
        ...
        var hrg_total = $('#grand_total_hidden').val();
