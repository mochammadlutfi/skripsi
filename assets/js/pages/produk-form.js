$(document).ready(function () {
    ...
    $("#form-produk").submit(function (e, foto) {
        ...
        $.ajax({
            url: laroute.route('produk.simpan'),
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
                ...
                if (response.fail == false) {
                    Swal.fire({
                        ...
                        html: `Data Produk Berhasil Disimpan!
                            ...
                            <button type="button" class="btn btn-tambah_baru btn-alt-primary"><i class="si si-plus mr-1"></i>Tambah Produk Lain</button>`,
                        ...
                        onBeforeOpen: () => {
                            ...
                            keluar.addEventListener('click', () => {
                                // window.setTimeout(function(){
                                    location.href = laroute.route('produk');
                                // } ,1000);
                            })
