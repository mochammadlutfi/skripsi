$(document).ready(function () {
    ...
    $("#form-variasi").submit(function (e){
        ...
        {
            // alert($('#field-variasi_id').val());
            formData.append('old_variasi_id', $('#field-variasi_id').val());
            ...
            formData.append('old_volume', $('#field-volume').val());
        ...
        $.ajax({
            url: laroute.route('variasi.tambah'),
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
    ...
    $("#form-kategori").submit(function (e) {
        ...
        $.ajax({
            url: laroute.route('kategori.simpan'),
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
    ...
    $("#form-produk").submit(function (e) {
        ...
        $.ajax({
            url: laroute.route('produk.update'),
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
    ...
    $("#form-ubah_variasi").submit(function (e) {
        ...
        $.ajax({
            url: laroute.route('variasi.changeRow'),
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
            ...
            success: function (response) {
                ...
                if (response.fail == true) {
                    ...
                    $('input[name^="variasi['+response.row+'][min_stok]"]').val(response.min_stok);
...
function ubah(id)
{
    ...
    $('#field-ubah_variasi_min_stok').val($('input[name^="variasi['+id+'][min_stok]"]').val());
    if($('input[name^="variasi['+id+'][satuan_id]"]').val() !== null)
    {
